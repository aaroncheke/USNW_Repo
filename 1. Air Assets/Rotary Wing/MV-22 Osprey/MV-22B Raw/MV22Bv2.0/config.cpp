...
class CfgMovesMaleSdr: CfgMovesBasic
{
	class States
	{
		...
		{
			actions="DeadActions";
			file="mv22b\data\anims\KIA_MV22_Pilot.rtm.ignore";
			speed=0.5;
			looped="false";
			terminal=1;
			soundEnabled=0;
...
class CfgVehicles
{
	...
	class turtle_MV22B: Plane_Base_F
	{
		...
		class Reflectors
		{
			class Right
			{
				position="R Light pos";
				direction="R Light dir";
			...
			class Left
			{
				position="L Light pos";
				direction="L Light dir";
				hitpoint="Light_hitpoint";
				selection="Light";
				size=1;
				color[]={7000,7500,10000};
